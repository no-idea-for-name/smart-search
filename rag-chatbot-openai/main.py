...
prompt_template = PromptTemplate.from_template(
    ...
    You always fulfill the user's requests to the best of your ability, even when the context provided does not help you with the users request, 
    in that case you apply your general knowledge, even when it risks giving an inaccurate answer.
    Context:
    {context}
